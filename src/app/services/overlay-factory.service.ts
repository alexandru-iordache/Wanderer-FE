        ...
        class CityOverlay extends google.maps.OverlayView {
            ...
            override onAdd() {
              ...
              `;
                ...
                const closeButton = div.querySelector('#close-overlay-btn') as HTMLButtonElement;
            ...
            override draw() {
                ...
                const position = overlayProjection.fromLatLngToDivPixel(new google.maps.LatLng(this.position));
